    ...
    const {id} = useParams();
      ...
      const submitForm =  (e) => {
        e.preventDefault();
            ...
            updateJobSubmit(updatedJob); // Call the parent function to handle the new job submission
            toast.success('Job updated successfully!'); // Show success message
        
            return navigate(`/jobs/${id}`); // Redirect to the job listings page after submission
      }
